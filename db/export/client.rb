...
def dump_clients(clients, f)
  clients.each_with_index do |c,i|
    ...
    bc_name = bc.present? ? bc.display_name : ""
    bp = c.business_profile
    f.puts("#{c.business_name}\##{c.business_address}\##{c.business_abn}\##{c.business_url}\##{c.business_phone}\##{c.business_fax}\##{c.business_email}\##{c.contact_name}\##{bc_name}\##{c.search_keyword}")
  end
end
