...
client_image = ClientImage.new(:source_url => "http://ads.yimg.com/la/adv/838460_230812/yahoo_sapphires_left_gutter_now_showing.jpg", :original_size => "160x800", :caption => "")
client_image.attached_to(client)
client_image = ClientImage.new(:source_url => "http://ads.yimg.com/la/adv/838460_230812/yahoo_sapphires_right_gutter_now_showing.jpg", :original_size => "160x800", :caption => "")
client_image.attached_to(client)
